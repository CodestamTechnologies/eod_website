        ...
        <div className="flex items-center justify-center h-full">
          ...
          <div className="text-white text-center space-y-6 relative z-20 max-w-4xl">
            ...
            <p className="text-lg md:text-xl lg:text-2xl font-medium leading-relaxed drop-shadow-md">
              Meet the passionate professionals behind our success. Our experienced team combines creativity, expertise, and dedication to deliver exceptional results for every project.
            </p>
          </div>
        </div>
      </div>
