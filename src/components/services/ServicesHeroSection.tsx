  ...
  return (
    <div className="relative w-full h-screen bg-red-600 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-10">
        {/* Shape 1 - Top Left */}
        <div className="absolute top-10 left-10 w-30 h-30">
          <Image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full">
          ...
          <div className="text-white space-y-6 relative z-20">
            ...
            <p className="text-lg md:text-xl lg:text-2xl font-medium leading-relaxed max-w-lg drop-shadow-md">
              Comprehensive solutions tailored to elevate your brand and drive meaningful engagement with your audience through innovative strategies.
            </p>
          </div>
